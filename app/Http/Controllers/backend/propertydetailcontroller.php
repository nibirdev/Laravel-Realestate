...
{
    //all property table url

    function allpropertydetails()
    {
        $properties = Propertydetail::latest()->get();
        return view('admin.property.all_property', compact('properties'));
    }
    //add property form
    function addpropertydetails()
    {
        $user = User::where('status', 'active')->where('role', 'agent')->latest()->get();;
        $Amenities = Amenities::all();
        $PropertyType = propertytype::all();
        $StateType = State::all();


        return view('admin.property.add_property', compact('user', 'Amenities', 'PropertyType', 'StateType'));
    }
    function storepropertydetails(Request $request)
    {
    ...
    function editpropertydetails($id)
    {
        ...
        return view('admin.property.edit_property', compact('property', 'user', 'Amenities', 'PropertyType', 'amenit', 'mulimage', 'facilities', 'StateType'));
    }
    function updatepropertydetails($id, Request $request)
    {
    ...
    function updatemultiimage(Request $request)
    {
    ...
    function addmultiimage(Request $request)
    {
    ...
    function updatefacility(Request $request)
    {
