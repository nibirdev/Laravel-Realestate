                    ...
                    <nav class="main-menu navbar-expand-md navbar-light">
                        <div class="collapse navbar-collapse show clearfix" id="navbarSupportedContent">
                            <ul class="navigation clearfix">
                                ...
                                <li><a href="{{route('home')}}"><span>About As</span></a></li>

                                <li class="dropdown"><a href="index.html"><span>Property</span></a>
                                    <ul>
                                        <li><a href="{{route('all.rent.type')}}">Rent Property List</a></li>
                                        <li><a href="{{route('all.buy.type')}}">Buy Property Grid</a></li>

                                    </ul>
                                </li>
                                <li><a href="{{route('home')}}"><span>Blog</span></a></li>
                                <li><a href="{{route('home')}}"><span>Agency List</span></a></li>
                                <li><a href="{{route('home')}}"><span>Contact</span></a></li>
                                <li><a href="index.html" class="btn btn-success text-hover-dark">+ Add Listing</a></li>
