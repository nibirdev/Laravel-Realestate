      ...
      <script src="{{asset('backend')}}/vendors/ace-builds/src-min/ace.js"></script>
      <script src="{{asset('backend')}}/vendors/ace-builds/src-min/theme-chaos.js"></script>
      <!-- End plugin js for this page -->

      <!-- Custom js for this page -->
      <script src="{{asset('backend')}}/js/tinymce.js"></script>
      <script src="{{asset('backend')}}/js/ace.js"></script>
      <!-- End custom js for this page -->
