            ...
            <div class="card rounded p-2">
                <div class="card-body ">
                    <div class="d-flex align-items-center justify-content-between mb-2 ">
                        ...
                        <div>
                            <img class="wd-60 rounded-circle" src="{{(!empty($profiledata->photo)) ? url('upload/agent_images/'.$profiledata->photo) : url('upload/no_image.jpg')}}" alt="profile">
        ...
        <div class="col-md-8 col-xl-8 middle-wrapper">
            <div class="card">
                <div class="card-body">
                    ...
                    <h6 class="card-title">Agent Update Panel</h6>
