            ...
            <div class="col-md-12 col-xl-12 middle-wrapper">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form class="forms-sample" method="POST" action="{{route('agent.update.property',$property->id)}}" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="mb-3">
                            ...
                            <div class="row">
                                <div class="col-sm-4">
                                    <div class="form-check form-check-inline">
                                        <input type="checkbox" name="featured" class="form-check-input my-2" id="checkInline" value="1" {{$property->featured=='1' ? 'checked':''}}>
                                ...
                                <div class="col-sm-4">
                                    <div class="form-check form-check-inline">
                                        <input type="checkbox" name="hot" class="form-check-input my-2" id="checkInline" value="1" {{$property->featured=='1' ? 'checked':''}}>
                                        <label class="form-check-label" for="checkInline">
                                            Hot
                                        </label>
                                    </div>
    ...
    <div class="col-md-12 grid-margin stretch-card">
        <div class="col-md-12 col-xl-12 middle-wrapper">
            <div class="card">
                <div class="card-body">
                    <h6 class="card-title">Edit Property</h6>
                    <form class="forms-sample" method="POST" action="{{route('agent.thumbnail.update.property',$property->id)}}" enctype="multipart/form-data">
...
<form class="forms-sample" method="POST" action="{{route('agent.mulimage.update.property')}}" enctype="multipart/form-data">
    @csrf
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="{{route('agent.mulimage.delete.property',$images->id)}}" class="btn btn-outline-danger">Delete</a>
                            </td>
...
<form class="forms-sample" method="POST" action="{{route('agent.mulimage.add.property')}}" enctype="multipart/form-data">
    @csrf
...
<form class="forms-sample" method="POST" action="{{route('agent.facilities.update.property')}}" enctype="multipart/form-data">
    @csrf
    <input type="hidden" name="id" value="{{$property->id}}">
    @php
    $i=1;
