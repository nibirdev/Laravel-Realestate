                        ...
                        <table id="dataTableExample" class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{route('agent.edit.property',$item->id)}}" class="btn btn-outline-primary">Edit</a>
                                        <a href="{{route('agent.delete.property',$item->id)}}" class="btn btn-outline-danger">Delete</a>
                                    </td>
